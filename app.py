...
def home_maps(chosen_jahr, chosen_monat, chosen_lichtverhaeltnisse, chosen_strassen, chosen_wochentag, chosen_unterkategorie, chosen_unfallart, chosen_map1, chosen_map2):
...
def home_sunburst(chosen_jahr, chosen_monat, chosen_lichtverhaeltnisse, chosen_strassen,
...
def vergleich_maps(chosen_monat, chosen_lichtverhaeltnisse, chosen_strassen, chosen_wochentag,
...
def vergleich_sunburst(chosen_monat, chosen_lichtverhaeltnisse, chosen_strassen, chosen_wochentag,
